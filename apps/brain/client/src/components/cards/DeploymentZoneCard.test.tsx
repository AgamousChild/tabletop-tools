...
describe('DeploymentZoneCard', () => {
  it('renders zone name', () => {
    render(
      <DeploymentZoneCard
        data={{ id: '1', name: 'DAWN OF WAR', description: 'Standard deployment.' }}
        context={mockContext}
      />,
    )
  ...
  it('renders battle size badge when provided', () => {
    render(
      <DeploymentZoneCard
        data={{ id: '1', name: 'Test', description: 'Desc', battleSize: 'Strike Force' }}
        context={mockContext}
      />,
    )
  ...
  it('renders description when no pdfImages', () => {
    render(
      <DeploymentZoneCard
        data={{ id: '1', name: 'Test', description: 'Standard 12" deployment zones.' }}
        context={mockContext}
      />,
    )
