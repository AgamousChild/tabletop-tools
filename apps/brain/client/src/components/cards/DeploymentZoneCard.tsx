  ...
  return (
    ...
    >
      <div className="px-3.5 py-2.5">
        {/* Header — zone name (left) + battleSize badge (right), green underline */}
        <div className="flex items-baseline justify-between border-b-2 border-green-500 pb-1 mb-1.5">
          ...
          {data.battleSize && (
            <span className="text-[9px] text-green-400 bg-green-400/10 px-1.5 py-0.5 rounded shrink-0 ml-2">
              {data.battleSize}
            </span>
          )}
        </div>
        ...
        {src ? (
          <div className="mb-1.5">
            ...
            <img
              src={src}
              alt={`${data.name} deployment zone diagram`}
