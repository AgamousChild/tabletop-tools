...
export const PRIMARY_MISSIONS: PrimaryMissionData[] = [
    ...
    scoringBlocks: [
      {
        ...
        conditions: [
          {
            condition: 'They control one objective marker not within their deployment zone',
            vp: '5 VP',
          },
          {
            condition: 'They control two objective markers not within their deployment zone',
            vp: '5 VP',
          },
          {
            condition: 'They control more objective markers than their opponent controls',
            vp: '5 VP',
          },
        ],
        connector: 'AND',
  ...
  // ── Page 2: BURDEN OF TRUST ──
  {
    ...
    isAsymmetric: false,
    description:
      'At the end of the Command phase, for each objective marker that player whose turn it is controls, they can select one unit from their army (excluding AIRCRAFT) within range of that objective marker to guard it until the start of their next turn.',
    scoringBlocks: [
      {
        timing: 'SECOND BATTLE ROUND ONWARDS',
        when: 'End of the Command phase (or the end of your turn if it is the fifth battle round and you are going second).',
        ...
        conditions: [
          {
            condition:
              'For each objective marker they control that is not within their deployment zone',
            vp: '4 VP',
          },
        ],
      },
      {
        ...
        conditions: [
          {
            condition:
              'For each of their units (excluding Battle-shocked units) that are within range of and guarding an objective marker they control',
            vp: '2 VP',
          },
        ],
      },
    ...
    designerNote:
      "Note that the player going second has the first chance to score VP in this way, as they can guard objectives in their first turn and score VP in their opponent's next turn.",
  },
    ...
    scoringBlocks: [
      {
        ...
        conditions: [
          {
            condition:
              'If the player does NOT control the objective marker in their deployment zone: For each objective marker that the player controls',
            vp: '3 VP',
          },
          {
            condition:
              'If the player DOES control the objective marker in their deployment zone: For controlling the objective marker in their deployment zone',
            vp: '3 VP',
          },
  ...
  // ── Page 4: PURGE THE FOE ──
  {
    ...
    scoringBlocks: [
      ...
      },
      {
        ...
        conditions: [
          {
            condition: 'If more enemy units than friendly units were destroyed this battle round',
            vp: '4 VP',
          },
        ],
      },
      {
        ...
        conditions: [
          ...
          {
            condition: 'If the player controls more objective markers than their opponent controls',
            vp: '4 VP',
          },
        ],
        connector: 'AND',
  ...
  // ── Page 5: SCORCHED EARTH ──
  {
    ...
    action: {
      ...
      units:
        'One unit from your army within range of an objective marker that is not within your deployment zone.',
      completes:
        "End of your opponent's next turn or the end of the battle (whichever comes first), if your unit is still within range of the same objective marker and you control that objective marker.",
    ...
    scoringBlocks: [
      {
        ...
        when: 'End of the Command phase (or the end of your turn if it is the fifth battle round and you are going second).',
        preamble:
          "The player whose turn it is scores VP for each objective marker within No Man's Land that they control, depending on the current battle round:",
        conditions: [
    ...
    scoringBlocks: [
      {
        ...
        when: 'End of the Command phase (or the end of your turn if it is the fifth battle round and you are going second).',
        preamble: 'The player whose turn it is scores:',
        conditions: [{ condition: 'For each objective marker that they control', vp: '5 VP' }],
      },
    ],
    maxVp: '15VP',
  },
  ...
  // ── Page 8: TERRAFORM ──
  {
    ...
    action: {
      ...
      units:
        'One or more units from your army, each within range of a different objective marker that is not within your deployment zone.',
      completes:
        'End of the turn, if the unit performing this Action is still within range of the same objective marker and you control that objective marker.',
      ifCompleted:
        'Each of those objective markers is terraformed by you. If that objective marker was terraformed by your opponent, it no longer is.',
    },
    scoringBlocks: [
      {
        timing: 'SECOND BATTLE ROUND ONWARDS',
        when: 'End of the Command phase (or the end of your turn if it is the fifth battle round and you are going second).',
        preamble: 'The player whose turn it is scores:',
        conditions: [{ condition: 'For each objective marker they control', vp: '4 VP' }],
      },
      {
        timing: 'SECOND BATTLE ROUND ONWARDS',
  ...
  // ── Page 9: THE RITUAL ──
  {
    ...
    action: {
      ...
      ifCompleted:
        'Set up one objective marker anywhere on the battlefield wholly within No Man\'s Land and within 1" of your unit, provided it can be set up exactly 12" from one other objective marker within No Man\'s Land and not within 6" of any other objective marker.',
    },
    scoringBlocks: [
      {
        timing: 'SECOND BATTLE ROUND ONWARDS',
        ...
        conditions: [
          {
            condition: "For each objective marker that the player controls in No Man's Land",
            vp: '5 VP',
          },
        ],
      },
  ...
  // ── Page 10: UNEXPLODED ORDNANCE ──
  {
    ...
    isAsymmetric: false,
    setupNote:
      "Start of the Battle: The objective markers within No Man's Land become Hazard objective markers.",
    action: {
      name: 'MOVE HAZARD',
      starts: 'Your Shooting phase.',
      units:
        'One or more units from your army, each within range of a different Hazard objective marker you control.',
      completes:
        'End of your turn, if the unit performing this Action is still within range of the same Hazard objective marker and you control that objective marker.',
      ifCompleted:
        'You can move each of those objective markers up to 6". That objective marker cannot end that move on top of any other objective marker or model, or inside impassable parts of terrain features.',
    },
    scoringBlocks: [
      {
        timing: 'SECOND BATTLE ROUND ONWARDS',
  ...
  // ── Page 11: SYPHONED POWER (Asymmetric) ──
  {
    ...
    action: {
      ...
      units:
        'Any number of units from your army, each within range of a different objective marker.',
      completes:
        'End of your turn, if your unit is still within range of the same objective marker and you control that objective marker.',
  ...
  // ── Page 13: DENIED RESOURCES (Asymmetric) ──
  {
    ...
    scoringBlocks: [
      ...
      },
      {
        ...
        conditions: [
          {
            condition: 'For each objective marker you control within your deployment zone',
            vp: '3 VP',
          },
          { condition: "For each objective marker you control within No Man's Land", vp: '5 VP' },
          {
            condition:
              "For each objective marker you control within your opponent's deployment zone",
            vp: '8 VP',
          },
        ],
      },
    ...
    scoringBlocks: [
      {
        ...
        conditions: [
          {
            condition:
              'If the player does NOT control each objective marker in their deployment zone: For each objective marker that the player controls',
            vp: '3 VP',
          },
          {
            condition:
              'If the player DOES control each objective marker in their deployment zone: For controlling each objective marker in their deployment zone',
            vp: '3 VP',
          },
          { condition: 'For each other objective marker that the player controls', vp: '5 VP' },
        ],
    ...
    scoringBlocks: [
      {
        ...
        conditions: [
          {
            condition: 'For each objective marker within their deployment zone that they control',
            vp: '2 VP',
          },
          {
            condition: "For each objective marker within No Man's Land that they control",
            vp: '4 VP',
          },
          {
            condition:
              "For each objective marker within their opponent's deployment zone that they control",
            vp: '6 VP',
          },
        ],
        connector: 'AND',
