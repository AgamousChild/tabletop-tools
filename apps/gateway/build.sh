...
for app in no-cheat versus list-builder game-tracker tournament new-meta data-import admin brain study physics; do
  echo "Building $app..."
...
echo "Gateway build complete: $DIST (all 11 apps validated)"
