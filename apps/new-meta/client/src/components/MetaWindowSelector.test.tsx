...
let mockFrames: Array<{ id: string; typeId: number; typeName: string; date: string; endDate: string; month: number; quarter: number; year: number; label: string }> = []
...
describe('MetaWindowSelector', () => {
  ...
  it('renders quarter frame options in the Quarters optgroup', () => {
    mockFrames = [
      { id: 'quarter:2025:1', typeId: 4, typeName: 'Quarter', date: '2025-01-01', endDate: '2025-03-31', month: 0, quarter: 1, year: 2025, label: 'Q1 2025' },
      { id: 'quarter:2025:2', typeId: 4, typeName: 'Quarter', date: '2025-04-01', endDate: '2025-06-30', month: 0, quarter: 2, year: 2025, label: 'Q2 2025' },
    ]
    render(<MetaWindowSelector value={undefined} onChange={() => {}} />)
  ...
  it('renders month frames in the Months optgroup', () => {
    mockFrames = [
      { id: 'month:2025:3', typeId: 3, typeName: 'Month', date: '2025-03-01', endDate: '2025-03-31', month: 3, quarter: 0, year: 2025, label: 'Mar 2025' },
    ]
    render(<MetaWindowSelector value={undefined} onChange={() => {}} />)
