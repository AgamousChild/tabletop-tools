...
describe('EvidencePrompt', () => {
  it('shows the loaded verdict', () => {
    render(
      <EvidencePrompt isLoaded={true} zScore={2.84} onSavePhoto={() => {}} onDismiss={() => {}} />,
    )
  ...
  it('shows the fair verdict', () => {
    render(
      <EvidencePrompt isLoaded={false} zScore={0.42} onSavePhoto={() => {}} onDismiss={() => {}} />,
    )
  ...
  it('calls onDismiss when the Dismiss button is clicked', () => {
    ...
    render(
      <EvidencePrompt isLoaded={true} zScore={2.84} onSavePhoto={() => {}} onDismiss={onDismiss} />,
    )
