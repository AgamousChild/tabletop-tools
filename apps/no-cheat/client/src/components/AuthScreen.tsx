  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        <h1 className="text-4xl font-bold text-amber-400 mb-1 text-center">NoCheat</h1>
        <p className="text-slate-400 text-center mb-8">Dice integrity for tabletop wargamers</p>
