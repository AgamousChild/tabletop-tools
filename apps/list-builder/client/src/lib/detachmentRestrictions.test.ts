...
import { parseDetachmentRestrictions, formatRestrictionText } from './detachmentRestrictions'
...
describe('formatRestrictionText', () => {
  it('strips bold markdown markers', () => {
    ...
    expect(formatRestrictionText(text)).toBe('Cannot include ADEPTUS ASTARTES units from any other Chapter.')
  })
